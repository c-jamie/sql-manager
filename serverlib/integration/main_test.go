...
func TestScriptRegister(t *testing.T) {
	...
	for _, tcase := range testcases {
		out, code := DoRequest(app, tcase.in, "/v1/files", "", http.MethodPost)
		t.Log(out.String())
...
func TestScriptGet(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, []byte(""), tcase.in, "", http.MethodGet)
		assert.Equal(t, tcase.code, code)
		assert.Equal(t, strings.Contains(out.String(), tcase.expect), true)
	}
	app.Migrations.DoMigrations("down")
...
func TestProjectGet(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, []byte(""), tcase.in, "", "GET")
		t.Log(out.String())
		assert.Equal(t, tcase.code, code)
		assert.Equal(t, strings.Contains(out.String(), tcase.expect), true)
	}
...
func TestAddMigration(t *testing.T) {
	...
	app := setup()
	for _, tcase := range testcases {
		out, code := DoRequest(app, tcase.in, "/v1/migrations", "", http.MethodPost)
		assert.Equal(t, tcase.code, code)
...
func TestGetMigration(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, []byte(""), tcase.url, "", http.MethodGet)
		assert.Equal(t, tcase.code, code)
...
func TestDeleteMigration(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, tcase.in, tcase.url, "", http.MethodDelete)
		assert.Equal(t, tcase.code, code)
...
func TestSetLatestMigration(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, tcase.in, tcase.url, "", http.MethodPost)
		assert.Equal(t, tcase.code, code)
...
func TestListMigrationTables(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, tcase.in, tcase.url, "", http.MethodGet)
		assert.Equal(t, tcase.code, code)
		t.Log(out.String())
	}
	app.Migrations.DoMigrations("down")
...
func TestUpdateMigration(t *testing.T) {
	...
	for _, tcase := range testcases {
		...
		out, code := DoRequest(app, tcase.in, tcase.url, "", http.MethodPatch)
		assert.Equal(t, tcase.code, code)
		t.Log(out.String())
	}
	app.Migrations.DoMigrations("down")
